...
ORDER BY emp_no; -- 899 total, First: 10021 Ramzi Erde

SELECT DISTINCT first_name, last_name, emp_no
FROM employees
WHERE last_name LIKE 'E%E'
ORDER BY emp_no DESC; -- Last: Last: 499648 Tadahiro Erde 
...
FROM employees
WHERE last_name LIKE 'E%E'
ORDER BY hire_date DESC; -- 899 total, Newest: Teiji Eldridge

SELECT DISTINCT first_name, last_name, hire_date
FROM employees
WHERE last_name LIKE 'E%E'
ORDER BY hire_date; -- Oldest: Sergi Erde
...
WHERE birth_Date LIKE '%-12-25' AND hire_date LIKE '199%' -- '199% is shorter
